...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        player_walk_1 = pygame.transform.scale_by(player_walk_1, 0.5)
        player_walk_2= pygame.image.load('graphics/player/player_walk_2.png').convert_alpha()
        player_walk_2 = pygame.transform.scale_by(player_walk_2, 0.5)

        self.player_walk = [player_walk_1, player_walk_2]
        self.player_index = 0
        self.player_jump = pygame.image.load('graphics/player/jump.png').convert_alpha()
        self.player_jump = pygame.transform.scale_by(self.player_jump, 0.5)

        self.image = self.player_walk[self.player_index]
        self.rect = self.image.get_rect(midbottom = (130, 299))
        self.gravity = 0
    ...
    def player_input(self):
        ...
        if keys[pygame.K_SPACE] and self.rect.bottom >= 299 :
            self.gravity = -11
    ...
    def apply_gravity(self):
        ...
        if self.rect.bottom >= 299 : self.rect.bottom = 299
...
class Obstacle(pygame.sprite.Sprite):
    def __init__ (self,type):
        ...
        if type == 'fly':
            ...
            fly_f1 = pygame.transform.scale_by(fly_f1, 0.7)
            fly_f2 = pygame.image.load('graphics/fly/fly2.png').convert_alpha()
            fly_f2 = pygame.transform.scale_by(fly_f2, 0.7)
            ...
            snail_f1 = pygame.transform.scale_by(snail_f1, 0.7)
            snail_f2 = pygame.image.load('graphics/snail/snail2.png').convert_alpha()
            snail_f2 = pygame.transform.scale_by(snail_f2, 0.7)
...
splash_img = pygame.image.load('graphics/bg.png').convert()
...
## load images
sky_img = pygame.image.load('graphics/Sky3.png').convert()
sky_rect = sky_img.get_rect(topleft = (0,0 ))
sky_rect2 = sky_img.get_rect(topleft = (800,0 ))

ground_img = pygame.image.load('graphics/ground2.png').convert()
ground_rect = ground_img.get_rect(topleft = (0,299 ))
ground_rect2 = ground_img.get_rect(topleft = (800,299 ))
...
player_stand= pygame.transform.scale_by(player_stand, 1)
...
while True:
    ...
    if game_active:
        ...
        if sky_rect.right <= 0:
            sky_rect.left = sky_rect2.right
        if sky_rect2.right <= 0:
            sky_rect2.left = sky_rect.right
